...
import com.example.demo.model.RolePermissionExample.Criteria;
import com.example.demo.model.RolePermissionExample.Criterion;
...
public class RolePermissionSqlProvider {
     ...
     * @mbg.generated
     */
    protected void applyWhere(SQL sql, RolePermissionExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
